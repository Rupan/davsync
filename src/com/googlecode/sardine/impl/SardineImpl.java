...
import net.temerity.http.auth.UsernamePasswordCredentials;
...
import net.temerity.http.client.methods.HttpDelete;
import net.temerity.http.client.methods.HttpGet;
import net.temerity.http.client.methods.HttpHead;
import net.temerity.http.client.methods.HttpPut;
...
import net.temerity.http.entity.InputStreamEntity;
import net.temerity.http.entity.StringEntity;
import net.temerity.http.impl.auth.BasicScheme;
import net.temerity.http.impl.client.AbstractHttpClient;
import net.temerity.http.impl.client.BasicAuthCache;
import net.temerity.http.impl.client.DefaultHttpClient;
import net.temerity.http.impl.client.DefaultRedirectStrategy;
import net.temerity.http.impl.conn.ProxySelectorRoutePlanner;
 ...
 *
 * @author jonstevens
 * @version $Id: SardineImpl.java 301 2011-08-28 12:45:57Z dkocher@sudo.ch $
 */
