...
import net.temerity.http.client.NonRepeatableRequestException;
import net.temerity.http.client.RedirectException;
import net.temerity.http.client.UserTokenHandler;
import net.temerity.http.client.methods.AbortableHttpRequest;
...
import net.temerity.http.conn.BasicManagedEntity;
...
import net.temerity.http.conn.routing.BasicRouteDirector;
import net.temerity.http.conn.routing.HttpRoute;
import net.temerity.http.conn.routing.HttpRouteDirector;
import net.temerity.http.conn.routing.HttpRoutePlanner;
import net.temerity.http.conn.scheme.Scheme;
import net.temerity.http.entity.BufferedHttpEntity;
import net.temerity.http.impl.conn.ConnectionShutdownException;
