...
import net.temerity.http.client.ClientProtocolException;
...
import net.temerity.http.client.RequestDirector;
...
import net.temerity.http.client.params.CookiePolicy;
...
import net.temerity.http.impl.DefaultConnectionReuseStrategy;
import net.temerity.http.impl.auth.BasicSchemeFactory;
import net.temerity.http.impl.auth.DigestSchemeFactory;
import net.temerity.http.impl.auth.NTLMSchemeFactory;
import net.temerity.http.impl.auth.NegotiateSchemeFactory;
import net.temerity.http.impl.conn.DefaultHttpRoutePlanner;
import net.temerity.http.impl.conn.SchemeRegistryFactory;
import net.temerity.http.impl.conn.SingleClientConnManager;
import net.temerity.http.impl.cookie.BestMatchSpecFactory;
import net.temerity.http.impl.cookie.BrowserCompatSpecFactory;
import net.temerity.http.impl.cookie.IgnoreSpecFactory;
import net.temerity.http.impl.cookie.NetscapeDraftSpecFactory;
import net.temerity.http.impl.cookie.RFC2109SpecFactory;
import net.temerity.http.impl.cookie.RFC2965SpecFactory;
import net.temerity.http.params.HttpParams;
import net.temerity.http.protocol.BasicHttpContext;
import net.temerity.http.protocol.BasicHttpProcessor;
import net.temerity.http.protocol.DefaultedHttpContext;
import net.temerity.http.protocol.HttpContext;
import net.temerity.http.protocol.HttpProcessor;
import net.temerity.http.protocol.HttpRequestExecutor;
import net.temerity.http.protocol.ImmutableHttpProcessor;
