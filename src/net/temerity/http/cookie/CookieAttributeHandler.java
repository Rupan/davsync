...
public interface CookieAttributeHandler {
   ...
   * {@link net.temerity.http.cookie.Cookie} property.
   *
   * @param cookie {@link net.temerity.http.cookie.Cookie} to be updated
   ...
   *
   * @param cookie {@link net.temerity.http.cookie.Cookie} to validate
   ...
   *
   * @param cookie {@link net.temerity.http.cookie.Cookie} to match
